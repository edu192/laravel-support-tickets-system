...
final class BackendDepartmentTable extends PowerGridComponent
{
    ...
    public function fields(): PowerGridFields
    {
        return PowerGrid::fields()
            ...
            ->add('name')
            ->add('updated_at')
            ->add('updated_at_formatted', fn(Department $row) => Carbon::parse($row->updated_at)->format('d/m/Y'))
            ->add('created_at')
            ->add('created_at_formatted', fn(Department $row) => Carbon::parse($row->created_at)->format('d/m/Y'));
    }
