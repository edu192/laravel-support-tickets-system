...
final class UnassignedTable extends PowerGridComponent
{
    use WithExport;
    ...
    : Builder
    {
        if (auth()->user()->department_id) {
            $category_ids = auth()->user()->department->categories->pluck('id');
            return Ticket::query()->doesntHave('assigned_agent')->whereIn('category_id', $category_ids);
        } else {
            return Ticket::query()->doesntHave('assigned_agent');
        }
    }
